...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LogQuarterProjectile>> LOG_QUARTER_PROJ;

    static {
        ENTITY_TYPES = DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, TFCWoodworking.MOD_ID);
    ...
    private static <T extends Entity> DeferredHolder<EntityType<?>, EntityType<T>> registerEntityType(String name, EntityType.EntityFactory<T> factory) {
