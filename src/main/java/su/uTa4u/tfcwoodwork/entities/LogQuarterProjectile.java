...
public final class LogQuarterProjectile extends AbstractWoodProjectile {

    public LogQuarterProjectile(EntityType<? extends AbstractWoodProjectile> entityType, Level level) {
